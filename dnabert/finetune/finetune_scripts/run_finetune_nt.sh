...
# paths
export DATA_DIR=/gpfs/scratch/jvaska/CAMDA_AMR/AMR_v2/dnabert/finetune/data/oof/run6_1000bp #this is base dir containing each fold directory, each containing dnabert_data/train.csv, test.csv, dev.csv
export BASE_RUN_NAME="nt_run6_1000bp_attempt1" #base run name, _{fold} will be attached
export BASE_OUT_DIR="/gpfs/scratch/jvaska/CAMDA_AMR/AMR_v2/dnabert/finetune/finetuned_models/${BASE_RUN_NAME}"
export MODEL_PATH="InstaDeepAI/nucleotide-transformer-v2-500m-multi-species" #change this to multispecies ***
